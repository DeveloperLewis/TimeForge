<div class="bg-custom-blue-light text-lg md:text-4xl flex flex-col whitespace-nowrap pt-5">
    ...
    <x-ui.general.dashboard_link href="/dashboard/entries">ENTRIES</x-ui.general.dashboard_link>
    ...
    <x-ui.general.dashboard_link href="/dashboard/account">ACCOUNT</x-ui.general.dashboard_link>
